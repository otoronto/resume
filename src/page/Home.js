...
const Home = (props) => {
  ...
  const pickBackgroundImage = () => {
    const imageList = [tus, flower, phone, matrix];
  ...
  return (
    <div className='container' style={{ backgroundImage: `url(${backgroundImage})` }}>
      ...
      {/*________________________________...FIX THIS...___________________________________  */}
      {
        (backgroundImage===tus) && <div className='overlay'></div> 
      }
